...
const ButtonTheme = ({ className = "" }) => {
  ...
  return (
    <label
      className={`relative flex h-7 w-14 cursor-pointer items-center justify-between overflow-hidden rounded-full bg-violet-950 p-1 text-yellow-500 dark:bg-violet-800 ${className}`}
    >
      <input
        type="checkbox"
